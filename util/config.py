...
# demo tr threshold
config.tr_thresh = 0.4  #original 0.8

# demo tcl threshold
config.tcl_thresh = 0.5  # original 0.5

# expand ratio in post processing
# config.expend = -0.05 #0.15 ctw1500
config.expend = 0.1
...
config.graph_link = True ### for Total-text icdar15 graph_link = False; forTD500 and CTW1500, graph_link = True
config.link_thresh = 0.75 #0.9
