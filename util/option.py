...
class BaseOptions(object):
    ...
    def __init__(self):
        ...
        # basic opts
        self.parser.add_argument('--exp_name', default="DAST1500", type=str,
                                 choices=['Synthtext', 'Totaltext', 'Ctw1500',
                                          'Icdar2015', "MLT2017", 'TD500', 'DAST1500'], help='Experiment name')
        self.parser.add_argument("--gpu", default="2", help="set gpu id", type=str)
        ...
        self.parser.add_argument('--mgpu', default=True, help='Use multi-gpu to train model')
        ...
        # train opts
        self.parser.add_argument('--max_epoch', default=800, type=int, help='Max epochs')
        ...
        self.parser.add_argument('--net', default='vgg', type=str,
                                 choices=['vgg', 'vgg_bn', 'resnet50', 'resnet101', 'efficientnet','eca_resnet18'],
        ...
        # self.parser.add_argument('--means', type=int, default=(0.5171, 0.4777, 0.4495), nargs='+', help='mean')  # ctw_train
        # self.parser.add_argument('--stds', type=int, default=(0.2563, 0.2495, 0.2447), nargs='+', help='std')

        #self.parser.add_argument('--means', type=int, default=(0.4802, 0.4502, 0.4436), nargs='+', help='mean')  # ctw_test
        #self.parser.add_argument('--stds', type=int, default=(0.2660, 0.2675, 0.2705), nargs='+', help='std')

        #self.parser.add_argument('--means', type=int, default=(0.45497396,0.42514301,0.39963974), nargs='+', help='mean')
        #self.parser.add_argument('--stds', type=int, default=(0.24789499,0.24360054,0.24558441), nargs='+', help='std')  # tt_train

        # self.parser.add_argument('--means', type=int, default=(0.46227579,0.42857848,0.40402679), nargs='+',
        #                          help='mean')
        # self.parser.add_argument('--stds', type=int, default=(0.25016906,0.24443062,0.24765875), nargs='+',
        #                          help='std')  # tt_test

        # self.parser.add_argument('--means', type=int, default=(0.49465218,0.48422671,0.43752776), nargs='+',
        #                          help='mean')
        # self.parser.add_argument('--stds', type=int, default=(0.2065919,0.20745175,0.2067793), nargs='+',
        #                          help='std')  # TD_train

        # self.parser.add_argument('--means', type=int, default=(0.49035637,0.47569445,0.43767943), nargs='+',
        #                          help='mean')
        # self.parser.add_argument('--stds', type=int, default=(0.20423114,0.20221714,0.20868407), nargs='+',
        #                          help='std')  # TD_test

        self.parser.add_argument('--input_size', default=640, type=int, help='model input size')
        # self.parser.add_argument('--test_size', default=(480, 980), type=tuple, help='model input size') # tt
        self.parser.add_argument('--test_size', default=(500, 1024), type=tuple, help='model input size')

        # eval args
        self.parser.add_argument('--checkepoch', default=705, type=int, help='Load checkpoint number')
        ...
        self.parser.add_argument('--link_thresh', default=0.75, type=float, help='link_thresh')
        self.parser.add_argument('--expend', default=0.1, type=float, help='expend')
        # demo args
