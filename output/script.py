...
from output import rrc_evaluation_funcs
import importlib
import zipfile
import os
import numpy as np
...
def default_evaluation_params():
    ...
    return {
        ...
        'DET_SAMPLE_NAME_2_ID': 'tr_img_([0-9]+).txt',
...
def eval_2015(res_folder):
    ...
    zip.close()
    #gtfile = os.path.join(current_folder, 'mltGT.zip')  # MLT2017
    #gtfile = os.path.join(current_folder, 'TDgt.zip')  # TD
    gtfile = os.path.join(current_folder, 'gt.zip')  # icdar2015
    params['g'] = gtfile
    params['s'] = submitfile
...
def getresult(i):
    ...
    #eval_2015('../../test')
    eval_2015('/data/chh/DRRG-master/output/MLT2017/{}/'.format(i))
...
# end_t = 148
#
# for i in range(start_t, end_t+1, 2):
#     getresult(i)
#     print("\n")
#     print(str(i) + '\n')
