...
# word_box
# gt_mat_path = '/data/chh/DRRG-master/data/SynthText/SynthText/gt.mat'
# im_root = '/data/chh/DRRG-master/data/SynthText/SynthText/'
# txt_root = '/data/chh/DRRG-master/data/SynthText/SynthText/gt/'
#
...
gt_mat_path = '/data/chh/DRRG-master/data/SynthText/SynthText/gt.mat'
im_root = '/data/chh/DRRG-master/data/SynthText/SynthText/'
txt_root = '/data/chh/DRRG-master/data/SynthText/SynthText/gt_char/'
...
for i, imname in enumerate(tqdm(gt['imnames'][0])):
    ...
    if len(gt['charBB'][0,i].shape) == 2:
        annots = gt['charBB'][0,i].transpose(1, 0).reshape(-1, 8)
    else:
        annots = gt['charBB'][0,i].transpose(2, 1, 0).reshape(-1, 8)
    with open(txt_path, 'w') as f:
        f.write(imname + '\n')
        for annot in annots:
            str_write = ','.join(annot.astype(str).tolist())
